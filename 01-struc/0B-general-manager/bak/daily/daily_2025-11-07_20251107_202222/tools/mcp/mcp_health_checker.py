...
class MCPHealthChecker:
    ...
    def __init__(self, mcp_root: str = None):
        ...
        if mcp_root is None:
            ...
            new_root = project_root / "tools" / "mcp" / "servers"
            old_root = project_root / "01-struc" / "MCPCluster"
            self.mcp_root = new_root if new_root.exists() else old_root
        else:
        ...
        # 日志目录（统一到 01-struc/0B-general-manager/logs；兼容层保留旧链接）
        self.log_dir = project_root / "01-struc" / "0B-general-manager" / "logs"
