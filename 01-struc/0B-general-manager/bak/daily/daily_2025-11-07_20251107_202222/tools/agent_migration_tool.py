...
class AgentMigrationTool:
    ...
    def _convert_to_v2_format(self, v1_config: dict, v2_name: str):
        ...
        v2_config = {
            ...
            "workspace": {
                "root": f"01-struc/Agents/{v2_name}",
                "documents": f"01-struc/Agents/{v2_name}/documents",
                "templates": f"01-struc/Agents/{v2_name}/templates", 
                "logs": f"01-struc/Agents/{v2_name}/logs",
                "config": f"01-struc/Agents/{v2_name}/config"
            },
