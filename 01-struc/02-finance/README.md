...
组织协作接口
- 关联可执行角色：`01-struc/Agents/finance_director/`（财务总监智能体）；协同 `01-struc/Agents/resource_admin/` 进行文档与资源治理。
...
运行参与说明
- 本目录通常不包含可执行代码；执行由相关 Agents 完成（财务总监与资源管理员等）。
...
快速索引
- 财务总监智能体：`01-struc/Agents/finance_director/`
