...
# 路径: S:\YDS-Lab\projects\001-dewatermark-ai\servers\local-pc\
...
from model_path_resolver import get_lama_model_path, get_output_dir

# 模型路径（支持外部目录配置）
LAMA_256_MODEL_PATH = get_lama_model_path()
...
def process_image():
    ...
    输出: {"output_path": "S:/YDS-Lab/projects/001-dewatermark-ai/output/frame_001_clean.png"}
    """
    try:
