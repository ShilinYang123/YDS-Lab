...
# 文件路径
DOMAIN_LIST_FILE = r"S:\YDS-Lab\03-dev\006-AUTOVPN\VPN-All\routes\需要获取IP的域名列表.txt"
FAILED_DOMAINS_FILE = r"S:\YDS-Lab\03-dev\006-AUTOVPN\VPN-All\routes\解析失败域名列表.txt"
IP_OUTPUT_FILE = r"S:\YDS-Lab\03-dev\006-AUTOVPN\VPN-All\routes\常用境外IP.txt"
WIREGUARD_CONFIG_FILE = r"S:\YDS-Lab\03-dev\006-AUTOVPN\VPN-All\config\wireguard\client\client.conf"
