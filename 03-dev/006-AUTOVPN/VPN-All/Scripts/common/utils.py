...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('S:\\YDS-Lab\\03-dev\\006-AUTOVPN\\VPN-All\\logs\\common_utils.log', encoding='utf-8'),
...
MEMORY_PATH = 'S:\\YDS-Lab\\03-dev\\006-AUTOVPN\\VPN-All\\memory.json'
