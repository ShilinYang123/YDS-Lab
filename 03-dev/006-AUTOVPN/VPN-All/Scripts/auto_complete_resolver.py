...
class AutoCompleteResolver:
    ...
    def run_batch_domain_resolver(self):
        ...
        try:
            ...
            ], capture_output=True, text=True, cwd='s:\\YDS-Lab\\03-dev\\006-AUTOVPN\\allout\\Scripts')
    ...
    def run_interactive_menu(self):
        ...
        try:
            ...
            self.menu_process = subprocess.Popen([
               ...
               stderr=subprocess.PIPE, text=True, cwd='s:\\YDS-Lab\\03-dev\\006-AUTOVPN\\allout\\Scripts')
