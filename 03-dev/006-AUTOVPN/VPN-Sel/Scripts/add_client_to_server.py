...
def get_client_public_key():
    """获取客户端公钥"""
    key_file_path = "S:/YDS-Lab/03-dev/006-AUTOVPN/VPN-Sel/config/wireguard/client/PC1_keys.txt"
...
def add_client_to_server():
    ...
    key_filename = "S:/YDS-Lab/03-dev/006-AUTOVPN/VPN-Sel/config/id_rsa"
