...
S:\YDS-Lab\03-dev\006-AUTOVPN\VPN-Sel\Scripts\wstunnel.exe --log-lvl DEBUG client -L udp://127.0.0.1:%WSTUNNEL_PORT%:127.0.0.1:%SERVER_RESTRICT_PORT% ws://%SERVER_IP%:%SERVER_PORT%
