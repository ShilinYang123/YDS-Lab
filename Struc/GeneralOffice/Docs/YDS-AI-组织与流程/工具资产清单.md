...
#### 4.2 MCP健康检查工具
- **位置**: `S:\YDS-Lab\tools2\mcp_health_checker.py`
- **功能**: 检查MCP服务器运行状态
- **特性**:
  - 服务器连接测试
  - 功能验证
...
#### 6.1 合规性监控工具
- **位置**: `S:\YDS-Lab\tools2\compliance_monitor.py`
- **功能**: 项目合规性实时监控
- **特性**:
  - 实时文件监控
  - 合规性检查
...
#### 6.2 质量检查工具
- **位置**: `S:\YDS-Lab\tools2\quality_checker.py`
- **功能**: 代码和文档质量检查
- **特性**:
  - 代码质量分析
  - 文档规范检查
...
#### 7.2 依赖管理工具
- **位置**: `S:\YDS-Lab\tools2\install_missing_components.py`
- **功能**: 自动安装缺失的依赖组件
- **特性**:
  - 依赖检测
  - 自动安装
...
#### 8.1 水印移除工具
- **位置**: `S:\YDS-Lab\tools2\WatermarkRemover\`
- **功能**: 视频水印智能移除
- **特性**:
  - 多种算法支持
  - GUI界面
