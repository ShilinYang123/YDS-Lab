$action = New-ScheduledTaskAction -Execute "powershell.exe" `
  -Argument '-NoProfile -ExecutionPolicy Bypass -File "S:\YDS-Lab\tools\LongMemory\health_check.ps1" -LogsRoot "S:\YDS-Lab\01-struc\0B-general-manager\logs\longmemory" -TraeLMPidFile "S:\YDS-Lab\03-dev\001-memory-system\TraeLM\trae-lm.pid" -Port 8765 -TestHost localhost'
